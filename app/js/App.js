...
/* harmony import */ var _modules_ModalBox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ModalBox */ "./app/src/modules/ModalBox.js");
...
var modalBox = new _modules_ModalBox__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
function () {
  function ModalBox() {
    ...
    this.modalBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-box');
  ...
  _createClass(ModalBox, [{
    ...
    value: function modalEvents() {
      // open the modal-box
      this.openModalBtn.click(this.openModal.bind(this)); // close the modal-box

      this.closeModalBtn.click(this.closeModal.bind(this)); //Push any key to close modal-box
